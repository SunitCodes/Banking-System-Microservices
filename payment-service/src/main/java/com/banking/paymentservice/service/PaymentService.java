...
public class PaymentService {
    ...
    // Payment flow:
    // 1. Create payment order in Razorpay
    // 2. Save payment record in database with status CREATED
    // 3. Razorpay will send webhook for payment success or failure
    ...
    public PaymentOrderResponse createPaymentOrder(
        ...
        payment.setStatus(String.valueOf(PaymentStatus.CREATED));
